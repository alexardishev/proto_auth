...
const (
	Analytics_StartETLProcess_FullMethodName = "/analyticsgrpc.Analytics/StartETLProcess"
)
...
type AnalyticsClient interface {
	StartETLProcess(ctx context.Context, in *StartETLProcessRequest, opts ...grpc.CallOption) (*StartETLProcessResponse, error)
}
...
func (c *analyticsClient) StartETLProcess(ctx context.Context, in *StartETLProcessRequest, opts ...grpc.CallOption) (*StartETLProcessResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(StartETLProcessResponse)
	err := c.cc.Invoke(ctx, Analytics_StartETLProcess_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AnalyticsServer interface {
	StartETLProcess(context.Context, *StartETLProcessRequest) (*StartETLProcessResponse, error)
...
func (UnimplementedAnalyticsServer) StartETLProcess(context.Context, *StartETLProcessRequest) (*StartETLProcessResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method StartETLProcess not implemented")
}
...
func _Analytics_StartETLProcess_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(StartETLProcessRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AnalyticsServer).StartETLProcess(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Analytics_StartETLProcess_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AnalyticsServer).StartETLProcess(ctx, req.(*StartETLProcessRequest))
	}
...
var Analytics_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "StartETLProcess",
			Handler:    _Analytics_StartETLProcess_Handler,
		},
	},
